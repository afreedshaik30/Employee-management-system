  ...
  return (
    ...
    <div className="flex justify-center mb-4">
      <button
        ...
        className="rounded bg-blue-950 text-white px-6 py-2 font-semibold hover:bg-blue-700 transition">
        Add Employee
      </button>
    </div>
    
    <div className="flex shadow border rounded-lg overflow-hidden">
